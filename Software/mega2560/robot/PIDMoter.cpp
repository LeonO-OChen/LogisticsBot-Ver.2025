...
void PIDMoter::setMotor(int mspeed) {
    ...
    /*
    使用分辨率11的电机：
      250rpm：减速比30，转一圈计数11*30*2=660，每分钟计数 660*250=165000次，每100毫秒165000/600=275次
      140rpm：减速比56，转一圈计数11*56*2=1232，每分钟计数 1232*140=172480次，每100毫秒172480/600=287.5次
      85rpm:  减速比90，转一圈计数11*90*2=1980，每分钟计数 1980*85=16830次，每100毫秒16830/600=280.5次
...
void PIDMoter::PIDControl() {
    ...
    // 增量式PID
    float pid = _kp * _bias[1] + _ki * _bias[0] + _kd * (_bias[1] - _bias[2]);
    _pwm += pid;
